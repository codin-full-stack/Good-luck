...
<div class="updateInfo">
    ...
    <form action="" method="POST" enctype="multipart/form-data">        
        ...
        <div class="bottom-buttons">
            ...
            <input type="submit" class="button" value="Atnaujinti" name="change">  
...
if(isset($_POST['change'])){
    ...
    if(!empty($_POST)){
        ...
        $sql = "UPDATE users SET name = '" . $_POST['name'] . "', lastname = '" . $_POST['pavarde'] . "', email = '" . $_POST['email'] . "', amzius = '" . $_POST['amzius'] . "', city = '" . $_POST['miestai'] . "', gender = '" . $_POST['lytis'] . "', picture = '" . $targetFile . "' WHERE id = '" . $user['id'] . "'";
